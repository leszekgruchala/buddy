...
def validate_review_contract(errors: list[str]) -> None:
    ...
    required_fragments = {
        ROOT / "skills/review-code/SKILL.md": (
            ...
            ".ai/memory/memory.md",
            "Only after an actual finding is `Fixed`",
            "A clean review, open finding",
        ...
        ROOT / "skills/review-code/references/review-method.md": (
            ...
            "Do not surface the snapshot, diff summary, changed-file inventory",
        ),
        ROOT / "agents/code-reviewer.md": (
            ...
            "Do not\ncreate a review file unless the user explicitly requested one",
        ),
        ROOT / "skills/develop/SKILL.md": (
            ...
            "reviewer returns findings\n   directly and creates no review file unless the user explicitly requested one",
        ),
        ...
        ROOT / "README.md": (
            ...
            "persistent report is written only when the user explicitly\nrequests one",
            ".ai/memory/memory.md",
            "at most two\nrounds",
        ),
    }
