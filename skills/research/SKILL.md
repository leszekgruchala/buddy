...
1. Read code and current primary documentation; never modify the working tree.
...
Persist only when requested. Reuse the passed worklog and `work-name`, or create `.ai/worklog/<yyyyMMdd>_<work-name>/`; save `.ai/worklog/<yyyyMMdd>_<work-name>/research_<work-name>.md` and put temporary files in `.ai/worklog/<yyyyMMdd>_<work-name>/trash/`.
